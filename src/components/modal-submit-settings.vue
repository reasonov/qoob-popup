<template>
  <modal-wrapper @closeModal="toggleSubmitModal('close')">
      ...
      <drop-menu :itemSelected="itemSelected">
        ...
        <template v-slot:item>
          ...
          <li v-for="(item, index) in list1" :key="item">
            <button :class="['drop__item', {'drop__item--last': index === list1.length}]" @click="selectItem(index, 'list1')">{{ item }}</button>
          </li>
      ...
      <drop-menu :itemSelected="itemSelected">
        ...
        <template v-slot:item>
          ...
          <li v-for="(item, index) in list2" :key="item">
            <button :class="['drop__item', {'drop__item--last': index === list2.length}]" @click="selectItem(index, 'list2')">{{ item }}</button>
          </li>
    ...
    <modal-main modalName="submitSettings" />
